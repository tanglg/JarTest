...
//        bidderList.put("28", BigDecimal.valueOf(28));
    ...
    public static void testComputeBasePrice() throws ScriptException {
        String zbfPath = "C:\\Users\\tanglg\\Desktop\\test001\\test001.zbf";


        //BasePrice priceObject= new BasePrice(zbfPath,"I1300000001000117001001","636903324990146947");
        BasePrice priceObject= new BasePrice(zbfPath,"I1301000075019085001004","637148507984429321");
...
//        OfferScore score = new OfferScore(zbfPath,"637110638130639734",2,"I1301000075019362001001");
